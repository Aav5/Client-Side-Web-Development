...
function validatePasswordMatch() {
  ...
  let enteredPassword = firstPassword.value
...
*/
let passInput1 = document.querySelector("#passwordInput");
passInput1.addEventListener("input", validatePasswordMatch);
let passInput2 = document.querySelector("#passwordConfirmInput");
passInput2.addEventListener("input", validatePasswordMatch);

// //passwordInput.validatePasswordMatch();
// let confirmpasswordInput = document.querySelectorAll("#passwordConfirmInput");
// //confirmpasswordInput.validatePasswordMatch();
// confirmpasswordInput.addEventListener("input", () => {
//   let y = confirmpasswordInput.value
//   confirmpasswordInput.validatePasswordMatch();
// })
