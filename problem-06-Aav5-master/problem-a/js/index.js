...
function renderTrack(results) {
  let track = document.getElementById("records");
  let image = document.createElement("img");
  image.src = results.artworkUrl100;
  image.alt = results.trackName;
  image.title = results.trackName;
...
function renderSearchResults(searchResults) {
  let element = document.querySelector('#records');
...
function renderError(object){
  ...
  alertBox.textContent = object.message;
  document.querySelector('#records').append(alertBox);
}
