...
let contain = motto.indexOf("cool");
...
let oldLen = motto.length;
let newLen = newMotto.length;
let ratio = (newLen/oldLen) * 100 ;
...
let rectArea = rect.height * rect.width;
...
//Log out the circle
let radius = numbers[10];
let circle = {'cx':34, 'cy':43, radius};
console.log(circle);
...
let triangle = {'base':33, 'height':44};
