...
function huskiesLost(game) {
  return (game.home == "UW" && game.home_score < game.opponent_score) ||
          (game.opponent == "UW" && game.home_score > game.opponent_score);
}
...
let gameLost = huskyGames2016.filter(huskiesLost);
...
let fumbledGames = huskyGames2016.filter((game) => {
...
function mostYardsPassing(game1, game2) {
  if (game1.passing_yards === undefined) return game2;
...
let gameLostFumbles = huskyGames2016.filter(fumbledAndLostFilter);
console.log(gameLostFumbles);
